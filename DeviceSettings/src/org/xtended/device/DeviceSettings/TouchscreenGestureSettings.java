...
import org.xtended.device.DeviceSettings.R;
...
public class TouchscreenGestureSettings extends PreferenceActivity
    ...
    public static class MainSettingsFragment extends PreferenceFragment {
        ...
        private SwitchPreference mGestureHapticsSwitch;
        ...
        private void initTouchscreenGestures() {
            ...
            mGestureHapticsSwitch = findPreference(KEY_TOUCHSCREEN_GESTURE_HAPTIC);
            boolean enabled = Settings.System.getInt(getContext().getContentResolver(),
                    KEY_TOUCHSCREEN_GESTURE_HAPTIC, 1) == 1;
            mGestureHapticsSwitch.setChecked(enabled);
            mGestureHapticsSwitch.setOnPreferenceChangeListener(
