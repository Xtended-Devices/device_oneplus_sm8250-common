...
const std::map<int32_t, TouchscreenGesture::GestureInfo> TouchscreenGesture::kGestureInfoMap = {
    ...
    {2, {253, "Right arrow", "/proc/touchpanel/left_arrow_enable"}},
    ...
    {9, {67, "Up arrow", "/proc/touchpanel/up_arrow_enable"}},
    {10, {66, "Up Swipe", "/proc/touchpanel/up_swipe_enable"}},
    {11, {63, "Right Swipe", "/proc/touchpanel/left_swipe_enable"}},
    {12, {65, "Left Swipe", "/proc/touchpanel/right_swipe_enable"}},
    {13, {64, "Down Swipe", "/proc/touchpanel/down_swipe_enable"}},
};
